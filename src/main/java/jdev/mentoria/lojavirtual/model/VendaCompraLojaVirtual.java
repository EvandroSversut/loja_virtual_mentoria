...
public class VendaCompraLojaVirtual implements Serializable {
	...
	private PessoaJuridica empresaJuridica;
		

	public PessoaJuridica getEmpresa() {
		return empresaJuridica;
	}

	public void setEmpresa(PessoaJuridica empresaJuridica) {
		this.empresaJuridica = empresaJuridica;
	}
	...
	public void setPessoa(PessoaJuridica pessoaFisica) {
		this.pessoaJuridica = pessoaFisica;
	}
